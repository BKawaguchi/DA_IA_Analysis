...
print('DA: {} 平均値: {} 比較値: {}'.format(DA_s_utility_sum, DA_s_utility_sum/T, (DA_s_utility_sum/T)/(S-DA_s_anmatch_sum/T)))
print('IA: {} 平均値: {} 比較値: {}'.format(IA_s_utility_sum, IA_s_utility_sum/T, (IA_s_utility_sum/T)/(S-IA_s_anmatch_sum/T)))
print()
print('研究室の効用, Utility of the laboratories')
print('DA: {} 平均値: {} 比較値: {}'.format(DA_c_utility_sum, DA_c_utility_sum/T, (DA_c_utility_sum/T)/(S-DA_s_anmatch_sum/T)))
print('IA: {} 平均値: {} 比較値: {}'.format(IA_c_utility_sum, IA_c_utility_sum/T, (IA_c_utility_sum/T)/(S-IA_s_anmatch_sum/T)))
print()
