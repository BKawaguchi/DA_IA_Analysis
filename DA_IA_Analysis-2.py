...
print('学生数: {} 研究室数: {} 研究室の定員: 各{}人'.format(S,C,CP[0]))
...
print('DA: {} 平均値: {} 割合: {}%'.format(DA_s_noenvy_sum, DA_s_noenvy_sum/T, ((DA_s_noenvy_sum/T)/S)*100))
print('IA: {} 平均値: {} 割合: {}%'.format(IA_s_noenvy_sum, IA_s_noenvy_sum/T, ((IA_s_noenvy_sum/T)/S)*100))
print()
